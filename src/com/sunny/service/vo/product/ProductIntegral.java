...
//===========积分产品-无属性==============//
	...
	public double useIntegral;//使用积分值
	public double useAmount;//使用金额
	public int isFullUseIntegral;//是否全部使用积分
	public int isUp; // 上下架
	...
	public int getIsFullUseIntegral() {
		return isFullUseIntegral;
	}
	public void setIsFullUseIntegral(int isFullUseIntegral) {
		this.isFullUseIntegral = isFullUseIntegral;
	}
	public int getIsUp() {
		return isUp;
	}
