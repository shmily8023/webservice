...
//===========票付通产品 设计测试？===========//
	...
	public int pftLid;// 票付通 lid
	public int pftAid;// 票付通 aid
	public int pftTid;// 票付通 tid
	public String prouctName;// 产品名称
	public int isUp; // 上下架
	...
	public String[] prductPrice;// 产品属性数组 productConfig_attr
