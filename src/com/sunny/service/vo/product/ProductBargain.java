...
public class ProductBargain {
	...
	public int bargainTotalNumbers; // 砍价总次数
	public String bargainRange;// 砍价范围 [100-3000] 以横线分割。配置时校验数据。末尾不得大于等于开头
	public double[] bargainLowPrice; // 可砍最低价 productConfig_attr
	public double[] bargainPrice;// 价格 productConfig_attr
	public int isUp; // 上下架
	...
	public int getBargainTotalNumbers() {
		return bargainTotalNumbers;
	}
	public void setBargainTotalNumbers(int bargainTotalNumbers) {
		this.bargainTotalNumbers = bargainTotalNumbers;
	}
	public String getBargainRange() {
		return bargainRange;
	}
	public void setBargainRange(String bargainRange) {
		this.bargainRange = bargainRange;
	}
	public double[] getBargainLowPrice() {
		return bargainLowPrice;
	}
	public void setBargainLowPrice(double[] bargainLowPrice) {
		this.bargainLowPrice = bargainLowPrice;
	}
