 ...
 * 
 */
@WebServiceClient(name = "SayHelloService", targetNamespace = "http://service.sunny.com/", wsdlLocation = "http://localhost:9091/service/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAYHELLOSERVICE_QNAME = new QName("http://service.sunny.com/", "SayHelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9091/service/hello?wsdl");
    ...
    public SayHello getSayHelloPort() {
        return super.getPort(new QName("http://service.sunny.com/", "SayHelloPort"), SayHello.class);
    }
    ...
    public SayHello getSayHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.sunny.com/", "SayHelloPort"), SayHello.class, features);
    }
