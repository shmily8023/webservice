 ...
 * generated in the com.sunny.client.config package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayResponse_QNAME = new QName("http://service.sunny.com/", "sayResponse");
    private final static QName _Say_QNAME = new QName("http://service.sunny.com/", "say");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.sunny.client.config
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.sunny.com/", name = "sayResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.sunny.com/", name = "say")
